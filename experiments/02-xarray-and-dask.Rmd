...
This document presents an example of how the [xarray](https://docs.xarray.dev/en/stable/index.html) and the [dask](https://www.dask.org/) Python library can be used together in R.
...
To show how the [xarray](https://docs.xarray.dev/en/stable/index.html) and [dask](https://www.dask.org/) can handle multidimensional data, we will create a dummy dataset with 3 dimensions: `X`, `Y`, and `Y`.

For this, let's create a 3D array using [Dask arrays](https://docs.dask.org/en/stable/array.html) with values:
